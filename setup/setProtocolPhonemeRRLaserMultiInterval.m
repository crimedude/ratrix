function r = setProtocolPhonemeRRLaserMultiInterval(r,subjIDs)
...
p=protocol('mouse phoneme discrimination LASER RR multiple timepoints',{ts1, ts2, ts3, ts4, ts5 ts6 ts7});

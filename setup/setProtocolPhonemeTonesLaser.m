function r = setProtocolPhonemeTonesLaser(r,subjIDs)
...
soundParams.soundType='toneLaser';
soundParams.freq = [];
...
p=protocol('mouse phoneme discrimination pure tones LASER',{ts1, ts2, ts3, ts4, ts5 ts6 ts7});
...
for i=1:length(subjIDs),
    ...
    [subj r]=setProtocolAndStep(subj,p,true,false,true,stepNum,r,'call to setProtocolPhonemeTones','edf');
end
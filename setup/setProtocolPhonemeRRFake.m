function r = setProtocolPhonemeRRFake(r,subjIDs)
...
soundParams.freq = [1]; %represents the starting time (relative to stim onset) of laser stimulation
...
p=protocol('mouse phoneme discrimination LASER RR Fake',{ts1, ts2, ts3, ts4, ts5 ts6 ts7});
...
for i=1:length(subjIDs),
    ...
    [subj r]=setProtocolAndStep(subj,p,true,false,true,stepNum,r,'call to setProtocolPhonemeRRLaserMultiInterval','edf');
end